...
- [ ] Payout tracking and payment history (payments index/detail shipped; create/edit in progress)
...
5. Navigate through dashboard, company management, job management, and payment routes (`/companies`, `/companies/create`, `/companies/:id`, `/jobs`, `/jobs/create`, `/jobs/:id`, `/jobs/:id/edit`, `/payments`, `/payments/:id`) to review list/detail workflows and payment CRUD entry points
