...
const routeStubs: Array<RouteStubDefinition> = [
    ...
    { path: "/jobs/123/edit", label: "Edit Job Route" },
    { path: "/jobs/j1", label: "Job Route" },
    { path: "/jobs/j1/edit", label: "Edit Job Route" },
    { path: "/payments", label: "Payments Route" },
    { path: "/payments/create", label: "Create Payment Route" },
    { path: "/payments/p1", label: "Payment Route" },
    { path: "/payments/p1/edit", label: "Edit Payment Route" },
