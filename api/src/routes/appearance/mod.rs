...
//! creating user-defined color palettes, and selecting active preset/custom
//! palettes for authenticated users.
//!
//! # Module Structure
//!
...
pub use handlers::{create_custom_palette, get_appearance, set_active_palette};

// Re-export payload types that are used by other modules.
pub use payloads::{CreateCustomPaletteRequest, SetActivePaletteRequest};
